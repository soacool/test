...
public:
    ...
    void setupUi(QWidget *addEleveDialog)
    {
        ...
        layoutWidget->setGeometry(QRect(440, 330, 171, 31));
        ...
        formLayout_15->setWidget(0, QFormLayout::LabelRole, addElvButton);

        annulerButton = new QPushButton(layoutWidget);
        annulerButton->setObjectName(QStringLiteral("annulerButton"));

        formLayout_15->setWidget(0, QFormLayout::FieldRole, annulerButton);
